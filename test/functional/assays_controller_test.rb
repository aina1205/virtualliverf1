...
test "should create experimental assay with or without sample" do
  ...
  test "download link for sop in tab has version" do
    ...
    assert_response :success
    post :resource_in_tab, {:resource_ids => [sops(:my_first_sop).id].join(","), :resource_type => "Sop", :view_type => "view_some", :scale_title => "all", :actions_partial_disable => 'false'}
  ...
  test "download link for data_file in tabs" do
    ...
    assert_response :success
    post :resource_in_tab, {:resource_ids => [data_files(:picture).id].join(","), :resource_type => "DataFile", :view_type => "view_some", :scale_title => "all", :actions_partial_disable => 'false'}
    assert_select "div.list_item div.list_item_actions" do
  ...
  def test_authorization_of_sops_and_datafiles_links
    ...
    post :resource_in_tab, {:resource_ids => data_file_ids.join(","), :resource_type => "DataFile", :view_type => "view_some", :scale_title => "all", :actions_partial_disable => 'false'}
    assert_response :success
    ...
    post :resource_in_tab, {:resource_ids => sop_ids.join(","), :resource_type => "Sop", :view_type => "view_some", :scale_title => "all", :actions_partial_disable => 'false'}
    assert_response :success
    assert_select "div.list_item" do
